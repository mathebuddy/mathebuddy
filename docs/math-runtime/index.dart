...
void main() {
  ...
  // TERM EVALUATION
  setElement('term-eval', '2^3 + 4 + sin pi');
  ...
  setElement('term-diff', '4x^2 + sin(x)');
  setElement('term-diff-var', 'x');
  ...
  // TERM COMPARISON
  setElement('term-compare-first', '2x');
  setElement('term-compare-second', 'x + x');
...
void setElement(String id, String value) {
  (document.getElementById(id) as InputElement).value = value;
}
