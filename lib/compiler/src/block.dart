  ...
  void parse(Compiler compiler, MbclLevel level, MbclLevelItem? parent,
    ...
    switch (id) {
      case 'ROOT':
        {
          ...
          for (var child in children) {
            var pseudoParent =
                MbclLevelItem(level, MbclLevelItemType.error, -1);
      ...
      case 'PART':
        {
          ...
          for (var key in attributes.keys) {
            ...
            switch (key) {
              ...
              default:
                var error =
                    MbclLevelItem(level, MbclLevelItemType.error, srcLine);
          ...
          var levelItem = MbclLevelItem(level, MbclLevelItemType.part, srcLine);
      ...
      case 'TODO':
        {
          ...
          var levelItem = MbclLevelItem(level, type, srcLine);
          parent?.items.add(levelItem);
      ...
      case "CENTER":
        {
          ...
          var align = MbclLevelItem(level, type, srcLine);
      ...
      case "ALIGNED-EQUATION*":
        {
          var equation =
              MbclLevelItem(level, MbclLevelItemType.equation, srcLine);
      ...
      case 'TABLE':
        {
          ...
          var table = MbclLevelItem(level, MbclLevelItemType.table, srcLine);
      ...
      case 'FIGURE':
        {
          ...
          var figure = MbclLevelItem(level, MbclLevelItemType.figure, srcLine);
      ...
      case 'EXERCISE':
        {
          ...
          _setChildrenDefaultType("PARAGRAPH");
          var exercise =
              MbclLevelItem(level, MbclLevelItemType.exercise, srcLine);
                ...
                case '=':
                  {
                    var sec = MbclLevelItem(
                        level, MbclLevelItemType.section, srcLine + i);
                ...
                case '-':
                  {
                    var subSec = MbclLevelItem(
                        level, MbclLevelItemType.subSection, srcLine + i);
